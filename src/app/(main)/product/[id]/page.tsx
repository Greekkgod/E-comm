        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-12 space-y-6">
            ...
            <div className="text-gray-700 space-y-4">
              <p>
                Experience the freshness of nature with Upvann&apos;s premium produce. Sourced directly from organic farms, our vegetables and fruits are hand-picked to ensure the highest quality and nutrition for your family. Packed with essential vitamins and minerals, they are the perfect addition to a healthy diet, bringing vitality and wellness to your daily life. We ensure safe and hygienic packaging so that the freshness is delivered intact to your doorstep. Embrace a healthier lifestyle with Upvann&apos;s fresh collection.
              </p>
            </div>
          </div>
          <div className="w-full mt-12">
          <UpvannShowCase item={allProducts.filter((p) => 
