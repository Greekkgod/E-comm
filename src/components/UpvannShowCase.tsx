...
import { upvannItems } from "@/utils/constants";
...
const UpvannShowCase = (
  {
    title= "Fresh & Healthy Groceries",
    subHeading= "Explore Our Wide Range of Vegetables and Fruits",
    item= null
  } : 
  { title ?: string;
    subHeading ?: string;
